---
description: Reflect on completed task and evolve playbooks (ACE core innovation)
allowed-tools: mcp__task__*, mcp__playbook__*, Task, Read
---
...
Observations are recorded via observe() during ACE commands (/research, /plan, /implement).
