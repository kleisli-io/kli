...
allowed-tools: mcp__task__*, mcp__playbook__*, Read, Glob
---
...
**Example**: `/ace:resume_handoff ace/tasks/2025-10-26-handoff-commands/handoffs/2025-10-26_14-30-00_phase-1.md`
...
**Example**: `/ace:resume_handoff 2025-10-26-handoff-commands`
...
- If no handoffs exist: "I can't find any handoff documents in this task. Would you like to create one with /ace:handoff?"
...
- Full path: `/ace:resume_handoff ace/tasks/2025-10-26-task/handoffs/2025-10-26_14-30-00_desc.md`
- Task name: `/ace:resume_handoff 2025-10-26-task-name`
