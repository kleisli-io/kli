...
allowed-tools: mcp__task__*, mcp__playbook__*, Read, Write
---
...
To resume from this handoff in a new session:
  /ace:resume_handoff [path from MCP tool]
```
...
- **Cross-reference ACE artifacts**: Always link to research.md and plan.md if they exist
