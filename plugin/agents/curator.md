...
tools: Read, Grep, mcp__playbook__pq_query
model: haiku
contract:
  input:
    format: json
    schema:
      ...
      properties:
        ...
        reflection_path:
          type: string
          description: Path to reflection.md containing update recommendations
      required:
        - task_dir
        - reflection_path
  output:
    schema:
      ...
      properties:
        ...
        feedback_given:
          type: integer
          description: Number of :feedback! mutations (helpful + harmful)
        patterns_added:
          type: integer
        patterns_evolved:
          type: integer
...
- You can ONLY use these tools: Read, Grep, and `pq_query` for PQ mutations (`(:feedback! ...)`, `(add! ...)`, `(:evolve! ...)`, `(search ...)`, `(pattern "id")`)
