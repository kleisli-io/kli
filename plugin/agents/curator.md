...
```json
{
  "task_dir": "/home/mika/src/amti/.kli/tasks/2025-12-12-feature-auth",
  "reflection_path": "/home/mika/src/amti/.kli/tasks/2025-12-12-feature-auth/reflection.md"
}
```

**Parameters:**
- `task_dir`: Path to the task directory (.kli/tasks/YYYY-MM-DD-description/)
