...
tools: Read, Bash, Grep, Write, Search, mcp__task__task_set_current, mcp__task__task_bootstrap, mcp__task__task_get, mcp__task__timeline, mcp__task__task_patterns, mcp__task__task_graph
model: opus
contract:
  input:
    format: json
    schema:
      ...
      properties:
        task_dir:
          type: string
          description: Path to the task directory (ace/tasks/YYYY-MM-DD-description/)
        task_id:
          type: string
          description: Task ID for MCP context (e.g., 2026-02-01-feature-auth)
        context:
          type: string
          description: Brief task description for framing the reflection
      required:
        - task_dir
        - task_id
        - context
  output:
    schema:
      ...
      properties:
        ...
        artifact:
          type: string
          description: Path to created reflection.md or null if failed
        summary:
          type: string
        patterns_evaluated:
          type: integer
