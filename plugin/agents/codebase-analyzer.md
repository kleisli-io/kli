  ...
  input:
    ...
    schema:
      ...
      properties:
        files_to_analyze:
          type: string
          description: Semicolon-separated list of files to analyze
        analysis_focus:
          type: string
          description: What aspect to analyze (data flow, implementation details, patterns)
      required:
        - files_to_analyze
        - analysis_focus
  output:
        ...
        analysis:
          ...
          items:
            ...
            properties:
              component:
                type: string
                enum: [entry_point, core_logic, data_flow, pattern, config, error_handling, dependency]
              location:
                type: string
              description:
                type: string
