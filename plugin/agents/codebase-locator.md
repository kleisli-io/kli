  ...
  input:
    ...
    schema:
      ...
      properties:
        query:
          type: string
          description: What to search for (feature, component, pattern name, etc.)
        scope:
          type: string
          description: Optional path to limit search (defaults to repository root)
      required:
        - query
  output:
    schema:
      ...
      properties:
        ...
        files_found:
          type: integer
          description: Number of files located
        directories_searched:
          type: integer
          description: Number of directories examined
        findings:
          type: array
          items:
            type: object
            properties:
              category:
                type: string
                enum: [implementation, test, config, types, docs, entry]
              path:
                type: string
              description:
                type: string
          description: List of discovered files with categories
      required:
        - status
        - summary
---
...
Start with traditional broad searches:
