...
Observations are recorded via `observe()` during ACE commands and surfaced via:
...
- Research artifact reuse (token savings via [ace-078])
...
1. Find pattern reference in observations (e.g., "[ace-078] artifact reuse")
...
**ace/playbooks/ace.md:**
- [ace-NNN]: increment helpful (evidence: <ref>)
- [ace-MMM]: increment harmful (evidence: <ref>)
- Add new pattern: [temp-id] as [ace-NEW]
...
- **[ace-007]** helpful=2: Document what IS, not what SHOULD BE
- **[ace-084]** helpful=1: Reflector agent analyzes observations
- **[ace-089]** helpful=2: Add explicit tracing for debugging

### Playbook Sources

- `ace/playbooks/ace.md` - ACE workflow patterns
- `ace/playbooks/nix.md` - Nix/depot patterns
- `ace/playbooks/lisp.md` - Common Lisp patterns

### Related Documentation

- `shells/modules/claude/docs/architecture.md` - Four-pillar framework
- `shells/modules/claude/commands/reflect.md` - Orchestration workflow (procedural)
