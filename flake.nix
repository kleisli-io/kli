    ...
    in {
      packages = forAllSystems (system:
        let
          ...
          # playbook-lib: pattern store, graph, activation engine (renamed from playbook-mcp)
          playbook-lib = buildLisp.library {
            name = "playbook";
            deps = [
