...
- :enrich - Load full CRDT state (adds :crdt-status, :obs-count, :edge-count, :session-count, :display-name)
...
Set tags on multiple tasks:
  (-> (node \"phase-\") (:set-meta! :tags \"needs-review\"))

Bulk sever phases from parent (replaces multiple task_sever calls):
  (-> (node \"phase-1\" \"phase-2\" \"phase-3\") (:sever-from-parent! :phase-of))
