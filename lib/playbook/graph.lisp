...
;;;    Source: .kli/playbook-manual-edges.json
...
;;;    Source: .kli/playbook-co-applications.json
...
(defvar *manual-edges-path* nil
  "Path to git-tracked manual edges file (.kli/playbook-manual-edges.json).
   Contains only :requires, :supersedes, :conflicts relations.
   Set via PLAYBOOK_EDGES_PATH env var or defaults to .kli/playbook-manual-edges.json.")
...
(defun co-app-ledger-path ()
  "Return path to co-app ledger file in .kli/ metadata directory.
   Returns NIL if .kli/ not found."
