...
(defvar *mutation-handler* nil
  "Function (op pattern-id &rest args) for executing mutations.
   Nil in lib/playbook, bound by playbook server.")
...
;;; ============================================================
;;; PATTERN-SET TYPE
;;; A pattern-set is a list of pattern structs (from playbook).
...
;;; Generic accessors that work with playbook::pattern structs
(defun pattern-id-accessor (p)
  "Get pattern ID. Works with playbook::pattern."
...
(defvar *pattern-packages* '(:playbook :kli-pattern)
